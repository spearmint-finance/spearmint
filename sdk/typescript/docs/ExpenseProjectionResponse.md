...
```typescript
import type { ExpenseProjectionResponse } from '@spearmint-money/sdk'
...
const example = {
  ...
  "modelMetrics": null,
} satisfies ExpenseProjectionResponse
...
const exampleParsed = JSON.parse(exampleJSON) as ExpenseProjectionResponse
