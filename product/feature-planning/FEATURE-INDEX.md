...
|-----|---------|-------|--------|------|
| [bank-data-aggregation.md](bank-data-aggregation.md) | Direct bank linking via Plaid | Accounts team | Draft | G2 |
...
| Budget management UI | P1 | G1/G2 | DB model exists, needs frontend design |
