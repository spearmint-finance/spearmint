...
test.describe("Transaction CRUD Operations", () => {
  ...
  test.describe("Create Transaction", () => {
    ...
    test("should validate required fields", async ({ page }) => {
      ...
      await expect(
        page.getByText(expectedValidationMessages.descriptionRequired)
      ).toBeVisible();
      await expect(
        page.getByText(expectedValidationMessages.amountRequired)
      ).toBeVisible();
    });
    ...
    test("should validate description length", async ({ page }) => {
      ...
      await fillFormField(
        page,
        "Description",
        invalidTransactions.shortDescription.description
      );
      ...
      await expect(
        page.getByText(expectedValidationMessages.descriptionTooShort)
      ).toBeVisible();
    });
    ...
    test("should validate amount is greater than zero", async ({ page }) => {
      ...
      // Should show validation error
      await expect(
        page.getByText(expectedValidationMessages.amountTooSmall)
      ).toBeVisible();
    });
  ...
  test.describe("Delete Transaction", () => {
    test("should show delete confirmation dialog", async ({ page }) => {
      ...
      if (rowCount > 0) {
        ...
        await expect(
          page.getByText("Are you sure you want to delete this transaction?")
        ).toBeVisible();
      }
    });
