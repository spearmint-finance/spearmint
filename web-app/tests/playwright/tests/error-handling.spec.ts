...
test.describe("Error Handling", () => {
  test.describe("Network Errors", () => {
    ...
    test("should show retry button on error", async ({ page }) => {
      ...
      await page.waitForSelector("text=/failed to load|error/i", {
        timeout: 10000,
      });
    ...
    test("should recover after retry when API becomes available", async ({
      page,
    }) => {
      let failCount = 0;
  ...
  test.describe("API Error Responses", () => {
    ...
    test("should show error toast on failed transaction creation", async ({
      page,
    }) => {
      await navigateTo(page, "/transactions");
      await waitForPageLoad(page);
    ...
    test("should show error toast on failed transaction update", async ({
      page,
    }) => {
      await navigateTo(page, "/transactions");
      await waitForPageLoad(page);
    ...
    test("should show error toast on failed transaction deletion", async ({
      page,
    }) => {
      await navigateTo(page, "/transactions");
      await waitForPageLoad(page);
