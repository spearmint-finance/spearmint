...
import { navigateTo, waitForPageLoad, clickSidebarItem } from './utils/test-helpers';
...
test.describe('Navigation', () => {
  ...
  test('should highlight active navigation item', async ({ page }) => {
    ...
    const transactionsButton = page.getByRole('button', { name: 'Transactions' });
  ...
  test('should preserve page state when navigating away and back', async ({ page }) => {
